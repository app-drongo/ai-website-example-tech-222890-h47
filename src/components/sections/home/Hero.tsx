...
const DEFAULT_HERO = {
  ...
  title: 'Build scalable tech solutions',
  titleHighlight: '10x faster',
  description:
    'Transform your ideas into production-ready applications with our cutting-edge development platform. Perfect for startups, scale-ups, and enterprise teams.',
  features: [
  ...
  imageAlt: 'Modern development dashboard',
  statsLabel1: 'Performance',
  statsValue1: '98 Lighthouse',
  statsLabel2: 'Deployment',
  statsValue2: '< 30 seconds',
} as const;
