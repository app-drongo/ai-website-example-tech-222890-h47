...
const DEFAULT_FOOTER = {
  ...
  newsletterDisclaimer:
    'Get weekly tech insights and product updates. Unsubscribe anytime with one click.',
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: 'Developer Portal', href: '/developers', editableId: 'link-footer-developers' },
